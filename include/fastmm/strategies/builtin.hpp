#pragma once
// The built-in strategies (basic_mm, avellaneda_stoikov, options_mm, xmm) as a strategy module, in
// the fastmm::strategies library. fastmm::cli::live, backtest and replay always register them
// first; run_backtest(cfg, name), replay_journal and sweep do so through
