...
inline constexpr std::size_t kProgramCapacity = 96;
...
[[nodiscard]] constexpr Program build_program(MapFds fds) noexcept {
  using namespace bpf;
  enum : std::size_t { LabelL3, LabelFallback, LabelPass };
