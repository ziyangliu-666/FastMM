...
- Strategies: [Register a strategy](how-to/strategies/register-a-strategy.md), [Write hot hooks in Python](how-to/strategies/python-hot-hooks.md), [Run a Python strategy live](how-to/strategies/python-live.md)
