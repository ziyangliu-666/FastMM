...
* Nasdaq TotalView-ITCH: no `api_key` / `api_secret` (`resolve_venue_env` does not ask for them); `rx_backend`, `dpdk_eal_args`, `dpdk_port`, `interface`, `line_a`, `line_b`, `line_a_interface`, `line_b_interface`, `line_a_source`, `line_b_source`, `queues`, `xdp_mode`, `rcvbuf`, `batch`, `rerequest`, `glimpse_url`, `glimpse_username`, `glimpse_password`, `reorder_packets`, `gap_timeout_ns`, `max_request_attempts`, `request_timeout_ns`, `recovery_buffer_packets`, `depth`, `price_window_ticks`, `max_orders`, `hw_timestamps`, `hw_clock`, `order_entry`, `ouch_url`, `ouch_username`, `ouch_password`, `order_transport`, `user_tcp_ip`, `user_tcp_interface`, `user_tcp_gateway`. Example: `configs/nasdaq-itch-sim.toml`.
