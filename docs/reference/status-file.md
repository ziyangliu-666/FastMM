...
- `magic` (`0x315441545353464D`, "MFSSTAT1" little-endian) and `version` (currently 2) sit at the
...
| `kills`, `kill_flags` | u64, u32 | kill switch trips and the current flag word |
