...
Status: accepted (2026-09); not implemented (the symbols and files below are the plan, not the code); market data amended by [ADR-0015](0015-multicast-market-data.md)
